...
- Added SmolLM2 model configs (`smollm2_135M`, `smollm2_360M`, `smollm2_1_7B`) reproducing the HuggingFaceTB SmolLM2 architectures (Llama-style: grouped-query attention, SwiGLU, RoPE, tied input/output embeddings).
