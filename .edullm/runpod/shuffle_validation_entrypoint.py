#!/usr/bin/env python3
"""Run shuffle-baseline 370M validation against the staged local manifest."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    import shuffle_validation

    _patch_worker_entrypoint(shuffle_validation)
    return shuffle_validation.main(list(argv) if argv is not None else None)
