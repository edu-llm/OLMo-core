...
EXPECTED_TOTAL_PARAMETERS = 392_197_248
EXPECTED_ACTIVE_PARAMETERS = 122_941_440
# Lngram's discretization and shared key/value projections are dense, so its active count
# is 2.72% above the base even though sparse table rows and routed experts stay near-isometric.
...
def build_model_config() -> TransformerConfig:
    ...
    override_indices = (2, model.n_layers // 2)
